...
import static id.application.endpoints.LetterEndpoint.DATA_FOUND;
import static id.application.endpoints.LetterEndpoint.DATA_TIDAK_DITEMUKAN;
...
public class HomeInformationEndpoint {
    ...
    public BaseResponse<PageResponse<HomeInformationDto>> getAll(@RequestParam(defaultValue = "0") Integer page,
        ...
        return BaseResponse.<PageResponse<HomeInformationDto>>builder()
                ...
                .message(result.isEmpty() ? DATA_TIDAK_DITEMUKAN : "Data ditemukan")
